package com.rtejos.eventos.controllers;
...
import com.rtejos.eventos.service.GranService;
import com.rtejos.eventos.validators.UserValidator;

@Controller
public class GranController {
	
	@Autowired
	GranService beltReviewerService;
	UserValidator userValidator;
	
	
	ArrayList<String> states = new ArrayList<String>(Arrays.asList("AL", "AK", "AZ", "AR", "CA", "CO", "CL",
			"CT", "DE", "FL", "GA", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN",
